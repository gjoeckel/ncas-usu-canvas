/**
 * NCADEMI Navigation JavaScript (v14)
...
(function () {
  ...
  const LOG_PREFIX = "🚀 NCADEMI Navigation v14";
  ...
  async function injectSignInBanner() {
    ...
    message.innerHTML = 'To take quizzes and track your progress, you will need to be signed in to this Canvas instance. <a href="http://usucourses.instructure.com/" target="_blank" rel="noopener noreferrer">Create a free account</a>.';
  ...
  function applyPageSpecificLogic() {
    ...
    if (isCoreSkillsPage) {
      ...
      // Check if user is signed in and inject banner if not
      injectSignInBanner();
